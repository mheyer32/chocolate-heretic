...
#define Sfx_SetVol(vol)                                                                                               \
    ({                                                                                                                \
        ...
        ({                                                                                                            \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Sfx_SetVol__bn - 30))(_Sfx_SetVol__bn, _Sfx_SetVol_vol); \
        });                                                                                                           \
    })
...
#define Sfx_Start(wave, cnum, step, vol, sep, length)                                                              \
    ({                                                                                                             \
        ...
        ({                                                                                                         \
            ...
            ((void (*)(char *__asm("a6"), char *__asm("a0"), int __asm("d0"), int __asm("d1"), int __asm("d2"),    \
                       int __asm("d3"), int __asm("d4")))(_Sfx_Start__bn - 36))(                                   \
                _Sfx_Start__bn, _Sfx_Start_wave, _Sfx_Start_cnum, _Sfx_Start_step, _Sfx_Start_vol, _Sfx_Start_sep, \
                _Sfx_Start_length);                                                                                \
        });                                                                                                        \
    })
    ...
    ({                                                                                                          \
        ...
        ({                                                                                                      \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0"), int __asm("d1"), int __asm("d2"), int __asm("d3")))( \
                _Sfx_Update__bn - 42))(_Sfx_Update__bn, _Sfx_Update_cnum, _Sfx_Update_step, _Sfx_Update_vol,    \
                                       _Sfx_Update_sep);                                                        \
        });                                                                                                     \
    })
...
#define Sfx_Stop(cnum)                                                                                           \
    ({                                                                                                           \
        ...
        ({                                                                                                       \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Sfx_Stop__bn - 48))(_Sfx_Stop__bn, _Sfx_Stop_cnum); \
        });                                                                                                      \
    })
...
#define Sfx_Done(cnum)                                                                                          \
    ({                                                                                                          \
        ...
        ({                                                                                                      \
            ...
            ((int (*)(char *__asm("a6"), int __asm("d0")))(_Sfx_Done__bn - 54))(_Sfx_Done__bn, _Sfx_Done_cnum); \
        });                                                                                                     \
    })
...
#define Mus_SetVol(vol)                                                                                               \
    ({                                                                                                                \
        ...
        ({                                                                                                            \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Mus_SetVol__bn - 60))(_Mus_SetVol__bn, _Mus_SetVol_vol); \
        });                                                                                                           \
    })
...
#define Mus_Register(musdata)                                                                                 \
    ({                                                                                                        \
        ...
        ({                                                                                                    \
            ...
            ((int (*)(char *__asm("a6"), void *__asm("a0")))(_Mus_Register__bn - 66))(_Mus_Register__bn,      \
                                                                                      _Mus_Register_musdata); \
        });                                                                                                   \
    })
...
#define Mus_Unregister(handle)                                                                                  \
    ({                                                                                                          \
        ...
        ({                                                                                                      \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Mus_Unregister__bn - 72))(_Mus_Unregister__bn,     \
                                                                                       _Mus_Unregister_handle); \
        });                                                                                                     \
    })
...
#define Mus_Play(handle, looping)                                                                  \
    ({                                                                                             \
        ...
        ({                                                                                         \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0"), int __asm("d1")))(_Mus_Play__bn - 78))( \
                _Mus_Play__bn, _Mus_Play_handle, _Mus_Play_looping);                               \
        });                                                                                        \
    })
...
#define Mus_Stop(handle)                                                                                           \
    ({                                                                                                             \
        ...
        ({                                                                                                         \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Mus_Stop__bn - 84))(_Mus_Stop__bn, _Mus_Stop_handle); \
        });                                                                                                        \
    })
...
#define Mus_Pause(handle)                                                                                             \
    ({                                                                                                                \
        ...
        ({                                                                                                            \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Mus_Pause__bn - 90))(_Mus_Pause__bn, _Mus_Pause_handle); \
        });                                                                                                           \
    })
...
#define Mus_Resume(handle)                                                                              \
    ({                                                                                                  \
        ...
        ({                                                                                              \
            ...
            ((void (*)(char *__asm("a6"), int __asm("d0")))(_Mus_Resume__bn - 96))(_Mus_Resume__bn,     \
                                                                                   _Mus_Resume_handle); \
        });                                                                                             \
    })
...
#define Mus_Done(handle)                                                                                           \
    ({                                                                                                             \
        ...
        ({                                                                                                         \
            ...
            ((int (*)(char *__asm("a6"), int __asm("d0")))(_Mus_Done__bn - 102))(_Mus_Done__bn, _Mus_Done_handle); \
        });                                                                                                        \
    })
