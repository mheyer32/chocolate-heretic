...
void I_InitGraphics(void)
{
    ...
    if (firsttime)
    {
        ...
        if (M_CheckParm ("-ntsc") || M_CheckParm ("NTSC"))
        {
        ...
        if (M_CheckParm ("-cgx") || M_CheckParm ("CGX") || M_CheckParm("-vampire2") || M_CheckParm("VAMPIRE2") )
        {

            if (M_CheckParm("-vampire2") || M_CheckParm("VAMPIRE2"))
                printf("Vampire II mode set \n");
            else
                printf("RTG mode set \n");
        ...
        if ((M_CheckParm ("-mmu") || M_CheckParm ("MMU")) && cpu_type >= 68040 && vidMode != VideoModeRTG)
    	{
