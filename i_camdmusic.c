...
static void I_CAMD_ShutdownMusic(void)
{
...
static boolean I_CAMD_InitMusic(void)
{
...
static void I_CAMD_SetMusicVolume(int volume)
{
...
static void I_CAMD_PlaySong(void *handle, boolean looping)
{
...
static void I_CAMD_PauseSong(void)
{
   Playing = FALSE;
}

static void I_CAMD_ResumeSong(void)
{
    
}

static void I_CAMD_StopSong(void)
{     
    if (p)
    {
...
static void I_CAMD_UnRegisterSong(void *handle)
{
...
char MIDIName[256];
static void *I_CAMD_RegisterSong(void *data, int len)
{        
    sprintf(MIDIName,"music/%s.mid",oggSongName);        
    ConvertMus(data, len, MIDIName);           
}
...
music_module_t music_camd_module =
{
    music_amiga_devices,
    arrlen(music_amiga_devices),
    I_CAMD_InitMusic,
    I_CAMD_ShutdownMusic,
    I_CAMD_SetMusicVolume,
    I_CAMD_PauseSong,
    I_CAMD_ResumeSong,
    I_CAMD_RegisterSong,
    I_CAMD_UnRegisterSong,
    I_CAMD_PlaySong,
    I_CAMD_StopSong,
    I_CAMD_MusicIsPlaying,
    I_CAMD_PollMusic,
};
