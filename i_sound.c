...
int snd_musicdevice = SNDDEVICE_PRISMA;
int snd_sfxdevice = SNDDEVICE_PAULA;

// Sound modules

extern sound_module_t sound_amiga_module;
extern music_module_t music_prisma_module;
extern music_module_t music_camd_module;
...
static void InitMusicModule(void)
{
    ...
    if (M_CheckParm("-prisma") || M_CheckParm("PRISMA"))
    {
        music_modules[0]->Init();
        music_module = music_modules[0];
    }
    if  (M_CheckParm("-camd") || M_CheckParm("CAMD"))
    {
        music_modules[1]->Init();
        music_module = music_modules[1];        
    }
...
{  
    ...
    if (M_CheckParm("-prisma") || M_CheckParm("PRISMA") || M_CheckParm("-camd") || M_CheckParm("CAMD"))
    {
        nomusic = false;
    }
    else
